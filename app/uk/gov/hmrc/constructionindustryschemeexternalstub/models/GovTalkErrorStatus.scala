...
object GovTalkErrorStatus {
  ...
  given OFormat[RecoverableError] = Json.format[RecoverableError]

  given OFormat[FatalError] = Json.format[FatalError]

  given OFormat[DepartmentalError] = Json.format[DepartmentalError]

  given OFormat[ServerError] = Json.format[ServerError]

  given OFormat[GovTalkErrorStatus] = new OFormat[GovTalkErrorStatus] {
